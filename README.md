...
| Repository | The "Official" Pitch | The Brutal Reality | If You Ask Me To Explain It |
| :--- | :--- | :--- | :--- |
| **[flying-lyrics](https://github.com/Crlyzd/flying-lyrics)** | Chrome/Edge PiP floating lyrics for Spotify & YouTube Music with live sync, romanization & translations. | Wanted to sing anime openings at 2 AM without Kanji. Bullied an LLM until canvas text floated. | *"It's an asynchronous event pipeline that synchronizes... the vibe." (fakes network lag)* |
| **[Cathet](https://github.com/Crlyzd/Cathet)** | Featherweight frosted Acrylic notepad for Windows with instant launch and Markdown preview (`Ctrl+M`). | Built out of spite because Windows Notepad takes 4 seconds to open an empty file. Asked AI for "expensive glass". | *"I recite the DWM Acrylic blur docs and pray you don't ask what a memory pointer is."* |
| **[Alitken-GUI](https://github.com/Crlyzd/Alitken-GUI)** | GPU-accelerated video trimmer & social clip cutter in Rust & Tauri v2 with lossless cuts. | Handbrake gave me a headache with 500 dropdowns. Told AI to build a cutter with zero buttons I can break. | *"Hardware NVENC muxing bypasses CPU thermal throttle states, you wouldn't get it."* |
| **[Alitken](https://github.com/Crlyzd/Alitken)** | Hardware-accelerated PowerShell media converter & splitter with `SendTo` menu integration. | Thousands of lines of terrifying PowerShell compiled into an `.exe`. Praying it doesn't wipe my C: drive. | *(Frantically pastes your question into ChatGPT and reads the first paragraph out loud)* |
| **[Bukaake](https://github.com/Crlyzd/Bukaake)** | Transparent, ultra-fast photo viewer reviving Google Picasa desktop immersion with frosted glass. | It means *"open it up"* in Javanese. Foreign devs panic thinking it's NSFW; it's literally just a picture viewer. | *"It's Javanese for 'open photo'!" (nervously pivots before you ask how the renderer works)* |
| **[Methik](https://github.com/Crlyzd/Methik)** | Portable 4K video & audio downloader for Windows (YouTube, TikTok, 320kbps/FLAC) with frosted UI. | Just `yt-dlp` wrapped in frosted acrylic to disguise my complete lack of backend knowledge. | *"It's a proprietary multi-threaded scraper I architected over an intense hackathon."* |
| **[kaleksananbagus.com](https://kaleksananbagus.com/)** | Personal digital garden, essays, travel journals, and mountain hiking logs. | **100% human sanctuary.** Zero AI hallucination—just real essays, mountain trails, and coffee logs. | *"I'll talk for 3 hours about philosophy and why you should touch grass instead of debugging."* |
