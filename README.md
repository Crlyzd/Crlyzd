...
<a href="https://skillicons.dev"><img src="https://skillicons.dev/icons?i=tauri,vite,react,vue,nextjs,tailwind,nodejs,cloudflare&perline=8" alt="Frameworks" /></a>
...
<div align="center">
  <p>
    💡 <strong>A Quick Cultural PSA on Repo Names</strong>: Most of these tools are named in <strong>Javanese</strong>, not English:<br />
    <code>Cathet</code> = <em>"Write it down"</em> &nbsp;•&nbsp; 
    <code>Alitken</code> = <em>"Make it smaller / compress"</em> &nbsp;•&nbsp; 
    <code>Methik</code> = <em>"To pluck / harvest"</em> &nbsp;•&nbsp; 
    <code>Bukaake</code> = <em>"Open it up"</em> (yes, get your mind out of the gutter, it's just an image viewer)
  </p>
</div>

| Repository | The "Official" Pitch | The Brutal Reality Behind The Code | What Happens If You Ask Me To Explain It | Stars |
| :--- | :--- | :--- | :--- | :--- |
| **[flying-lyrics](https://github.com/Crlyzd/flying-lyrics)** | Chrome & Edge extension providing a floating PiP lyrics window for Spotify & YouTube Music with live sync, romanization (Romaji, Romaja, Pinyin), and translations. | I wanted to sing anime openings at 2 AM without knowing Kanji. I terrorized an LLM for 48 hours until it hijacked the browser DOM and manifested floating canvas text. | *"I stare blankly into your webcam, sweat through my shirt, and whisper: 'It's an asynchronous event listener pipeline that synchronizes... the vibe.' Then I fake a network disconnection."* | ![Stars](https://img.shields.io/github/stars/Crlyzd/flying-lyrics?style=flat-square&color=7aa2f7&labelColor=1a1b26) |
| **[Cathet](https://github.com/Crlyzd/Cathet)** | Featherweight, frosted-glass Acrylic notepad for Windows with instant launch, zero RAM bloat, portable `.exe`, and Markdown preview (`Ctrl+M`). | Named after the Javanese word for *"write it down"*. Built out of pure spite because modern Windows Notepad takes 4 seconds to open an empty file. I told the AI to make it look like expensive frosted glass. | *"I will passionately recite the Wikipedia page for Windows Desktop Window Manager Acrylic blur and pray to God you don't ask what a memory pointer is."* | ![Stars](https://img.shields.io/github/stars/Crlyzd/Cathet?style=flat-square&color=7aa2f7&labelColor=1a1b26) |
| **[Alitken-GUI](https://github.com/Crlyzd/Alitken-GUI)** | High-performance GPU-accelerated video trimmer, media converter, and social clip studio (lossless cuts, 1-click TikTok/Reels framing) in Rust & Tauri v2. | Javanese for *"compress it / make it smaller"*. Handbrake and Premiere gave me a migraine with 500 dropdown menus. I demanded the AI build a slick GPU cutter with zero buttons I can mess up. | *"I nod aggressively, stroke my chin, and say: 'Hardware NVENC muxing bypasses CPU thermal throttle states, you wouldn't get it.'"* | ![Stars](https://img.shields.io/github/stars/Crlyzd/Alitken-GUI?style=flat-square&color=7aa2f7&labelColor=1a1b26) |
| **[Alitken](https://github.com/Crlyzd/Alitken)** | Interactive hardware-accelerated PowerShell media converter & video splitter with `SendTo` context menu integration and `libdav1d` AV1 decoding. | Thousands of lines of terrifying PowerShell scripts that I compiled into a portable `.exe`. It renders microsecond progress bars while I stare at the screen praying it doesn't nuke my hard drive. | *"I frantically Alt-Tab to an AI chat, paste your question into the prompt box, and read the first paragraph out loud with unearned confidence."* | ![Stars](https://img.shields.io/github/stars/Crlyzd/Alitken?style=flat-square&color=7aa2f7&labelColor=1a1b26) |
| **[Bukaake](https://github.com/Crlyzd/Bukaake)** | Ultra-fast, transparent photo viewer reviving the classic Google Picasa desktop immersion with stroke-free frosted glass. | It literally means *"Open it up"* in Javanese (<code>Buka-ake</code>). Every non-Indonesian dev on GitHub sees the name, turns pale, and thinks I committed an NSFW repo. It's a completely innocent picture viewer. | *"I immediately start laughing, clarify that it's Javanese for 'open this photo', and swiftly change the subject before you ask me how the Rust canvas renderer works."* | ![Stars](https://img.shields.io/github/stars/Crlyzd/Bukaake?style=flat-square&color=7aa2f7&labelColor=1a1b26) |
| **[Methik](https://github.com/Crlyzd/Methik)** | Modern, portable 4K video and music downloader for Windows supporting 1,000+ sites (YouTube playlists, TikTok, Reels, MP3 320kbps/FLAC) with frosted-glass UI. | Javanese for *"plucking / harvesting"* fruits from a tree, except here we are harvesting 4K mp4s and 320kbps MP3s from YouTube. Powered by <code>yt-dlp</code> wrapped in frosted glass to hide my lack of backend knowledge. | *"I claim it's a proprietary multi-threaded algorithmic web scraper that I architected myself during an intense weekend hackathon."* | ![Stars](https://img.shields.io/github/stars/Crlyzd/Methik?style=flat-square&color=7aa2f7&labelColor=1a1b26) |
| **[kaleksananbagus.com](https://kaleksananbagus.com/)** | Personal digital garden, essays, travel journals, and mountain hiking logs. | **The only 100% human sanctuary.** Zero AI hallucination, just my own essays, mountain trails, deep thoughts, and coffee ramblings. | *"I will talk your ear off for 3 hours about philosophy, trail hiking, and why you should touch grass instead of staring at terminal errors."* | — |
